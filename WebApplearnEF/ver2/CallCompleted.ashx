23<%@ WebHandler Language="C#" Class="JHandler" %>
...
public class JHandler : IHttpHandler
{
    ...
    private void saveContextinSession()
    {
        string cellsessionid = httpContext.Request.QueryString["CallSid"];
        httpContext.Application.Remove(cellsessionid); 
    }
